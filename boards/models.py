...
class ProductImages(models.Model):
    name = models.ForeignKey(Products, related_name='name', on_delete=models.CASCADE)
    images = models.ForeignKey(Products, related_name='images', on_delete=models.CASCADE)
...
class SubCategory(models.Model):
    category = models.ForeignKey(Category, related_name='name', on_delete=models.CASCADE)
    subcategory = models.ForeignKey(Products, related_name='subcategory', on_delete=models.CASCADE)
